...
#ifndef INCLUDED_SATELLITES_VARLEN_PACKET_TAGGER_PDU_IMPL_H
#define INCLUDED_SATELLITES_VARLEN_PACKET_TAGGER_PDU_IMPL_H
...
namespace gr {
  namespace satellites {
    ...
    class varlen_packet_tagger_pdu_impl : public varlen_packet_tagger_pdu
    {
     private:
...
#endif /* INCLUDED_SATELLITES_VARLEN_PACKET_PDU_IMPL_H */
